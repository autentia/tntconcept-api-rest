...
public class ActivitiesDayController {
	...
	public List<ActivitiesDay> getActivitiesByDates(
			...
			@RequestParam(name = "endDate") @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate endDate, Principal principal) {
	...
	public ActivitiesDay getActivitiesByDay(
			@RequestParam(name = "date", required = true) @DateTimeFormat(iso = ISO.DATE_TIME) LocalDateTime date,  Principal principal) {
		User user = userService.getUserByLogin(principal.getName());
		ActivitiesDay activitiesDay = new ActivitiesDay();
	...
	public double getActivitiesTime(
			...
			@RequestParam("endDate") @DateTimeFormat(iso = ISO.DATE_TIME) LocalDateTime endDate, Principal principal) {
		User user = userService.getUserByLogin(principal.getName());
